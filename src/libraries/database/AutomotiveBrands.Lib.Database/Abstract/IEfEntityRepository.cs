namespace AutomotiveBrands.Lib.Database.Abstract
{
    ...
    public partial interface IEfEntityRepository<TEntity> where TEntity : class, IEntity, new()
    {
        /// <summary>
        ...
        Task<List<TEntity>> GetAllAsync(Expression<Func<TEntity, bool>> filter = null, bool disableTracking = true);
        ...
        /// <returns>entities</returns>
        Task<List<TEntity>> GetAllAsync(Expression<Func<TEntity, bool>> filter, Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>> orderBy, params string[] includeProperties);
        ...
        /// <summary>
        /// Any by expression filter
        /// </summary>
        /// <remarks>method that can be overridden</remarks>
        /// <param name="filter">filter</param>
        /// <param name="disableTracking">entity state tracking filter</param>
        /// <returns>type of boolean</returns>
        ValueTask<bool> AnyAsync(Expression<Func<TEntity, bool>> filter, bool disableTracking = true);

        /// <summary>
        /// All by expression filter
        /// </summary>
        /// <remarks>method that can be overridden</remarks>
        /// <param name="filter">filter</param>
        /// <param name="disableTracking">entity state tracking filter</param>
        /// <returns>type of boolean</returns>
        ValueTask<bool> AllAsync(Expression<Func<TEntity, bool>> filter, bool disableTracking = true);
        ...
        ValueTask InsertRangeAsync(IEnumerable<TEntity> entities, CancellationToken cancellationToken = default);

        /// <summary>
        /// Update by property name
        /// </summary>
        /// <remarks>method that can be overridden</remarks>
        /// <param name="entity">entity</param>
        /// <param name="propertyName">property name</param>
        /// <exception cref="ArgumentException">when there are no entity for the property</exception>
        void UpdateByPropertyName(TEntity entity, string propertyName);
